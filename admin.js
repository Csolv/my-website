(function () {
  ...
  var overlayHTML = [
    ...
    '        <div class="adm-sidebar-section">HERRAMIENTAS IA</div>',
    '        <button class="adm-nav-item" onclick="window.location.href=\'admin/grant-roadmap.html\'">🗺️ Mapa de Grants</button>',
    '        <button class="adm-nav-item" onclick="window.location.href=\'admin/legal-guide.html\'">⚖️ Guía Legal</button>',
    '        <button class="adm-nav-item" onclick="window.location.href=\'admin/social-media-gen.html\'">📱 Generador Redes</button>',
    '        <button class="adm-nav-item" onclick="window.location.href=\'admin/adc-run-game.html\'">⚽ ADC Run</button>',
    ...
    '              <button class="adm-btn adm-btn-outline" onclick="window.location.href=\'admin/grant-roadmap.html\'">🗺️ Mapa de Grants</button>',
    '              <button class="adm-btn adm-btn-outline" onclick="window.location.href=\'admin/legal-guide.html\'">⚖️ Guía Legal</button>',
    '              <button class="adm-btn adm-btn-outline" onclick="window.location.href=\'admin/social-media-gen.html\'">📱 Generador Redes</button>',
    '              <button class="adm-btn adm-btn-outline" onclick="window.location.href=\'admin/adc-run-game.html\'">⚽ ADC Run</button>',
    '            </div>',
    '          </div>',
    '        </div>',
